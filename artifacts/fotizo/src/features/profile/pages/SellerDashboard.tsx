                ...
                <tr key={product.id} className="hover:bg-muted/30">
                  ...
                  <td className="px-6 py-4 text-right">
                    <div className="flex justify-end gap-2">
                      <Button aria-label="View product" variant="ghost" size="icon" className="h-8 w-8 text-muted-foreground hover:text-primary"><Eye className="w-4 h-4" /></Button>
                      <Button aria-label="Edit product" variant="ghost" size="icon" className="h-8 w-8 text-muted-foreground hover:text-primary"><Edit2 className="w-4 h-4" /></Button>
                    </div>
                  </td>
                </tr>
              ))}
