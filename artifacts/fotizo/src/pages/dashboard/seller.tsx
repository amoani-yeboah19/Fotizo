...
import { sellerProducts, mockOrders } from "@/data/mockData";
    ...
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <div className="flex-1 flex pt-20">
        <aside className="w-64 border-r border-border bg-white hidden md:block">
          <div className="p-6">
            <h3 className="text-xs font-semibold text-muted-foreground uppercase tracking-wider mb-4">Seller Portal</h3>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
              <div className="bg-white p-6 rounded-2xl border border-border shadow-sm">
                ...
                <h4 className="text-3xl font-bold text-primary">£4,280</h4>
              ...
              <div className="bg-white p-6 rounded-2xl border border-border shadow-sm">
                <p className="text-sm font-medium text-muted-foreground mb-1">Orders to Fulfill</p>
                <h4 className="text-3xl font-bold text-accent">12</h4>
              </div>
              <div className="bg-white p-6 rounded-2xl border border-border shadow-sm">
