...
export const MOCK_USERS: (User & { password: string })[] = [
  { id: "u1", name: "Alex Morgan", email: "buyer@fotizo.com", password: "password", role: "buyer", avatar: "/images/avatar-1.png", joinedAt: "2024-01-15", verified: true },
  { id: "u2", name: "Sarah Jenkins", email: "seller@fotizo.com", password: "password", role: "seller", avatar: "/images/avatar-2.png", joinedAt: "2023-11-08", verified: true },
  { id: "u3", name: "James Carter", email: "manager@fotizo.com", password: "password", role: "manager", avatar: "/images/avatar-3.png", joinedAt: "2023-06-01", verified: true },
  { id: "u4", name: "Priya Sharma", email: "developer@fotizo.com", password: "password", role: "developer", avatar: "/images/avatar-4.png", joinedAt: "2024-03-20", verified: true },
];
...
export const INITIAL_CONVERSATIONS: Conversation[] = [
  {
    ...
    messages: [
      ...
      { id: "m2", senderId: "u2", senderName: "Sarah Jenkins", senderAvatar: "/images/avatar-2.png", content: "Thanks for reaching out! The headphones are in stock and ready to ship.", timestamp: "2026-07-01T14:30:00Z", read: false },
    ],
  },
  {
    id: "conv2",
    ...
    messages: [
      ...
      { id: "m4", senderId: "u3", senderName: "Elena Rodriguez", senderAvatar: "/images/avatar-3.png", content: "I can schedule a 30-minute discovery call on Thursday at 2pm GMT. Does that work?", timestamp: "2026-06-30T09:15:00Z", read: true },
    ],
  },
];
